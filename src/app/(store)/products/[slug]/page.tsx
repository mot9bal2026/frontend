...
const content: Record<string, {
  ...
  "wrinkles-dark-circles": {
    ...
    expertQuote: "أغلب حالات آلام الركبة والظهر التي تصلني لا تحتاج فعلاً لعملية جراحية، بل لعلاج موضعي يصل لمكان الألم ويعالج الالتهاب من جذوره. زيت العوافي بخلطة أعشابه الطبيعية أعطى نتائج ممتازة مع أكثر من 2401 حالة خلال شهر — كثير منهم استغنوا عن العملية. الأهم هو الاستمرار على الاستخدام اليومي مرتين.",
      ...
      <section className="cv-auto py-10 md:py-14 px-4 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-6 md:mb-8">
            ...
            <p className="text-[#5A4A3E] text-sm mt-1">لأنه ليس مجرد زيت. هو خلطة أعشاب طبيعية بتركيز واضح، مصادق عليها، وأثبتت نتائج مع أكثر من 2401 حالة في شهر واحد.</p>
          </div>
