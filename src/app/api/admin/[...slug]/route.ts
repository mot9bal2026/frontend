...
const NAMES = [
  "عبدالله الشمري", "محمد القرشي", "فهد الشهري", "سعود العنزي", "ناصر العتيبي",
  "خالد الدوسري", "أبو تركي", "علي الحربي", "سلطان السبيعي", "بدر الغامدي",
  "ماجد الرشيد", "يوسف القحطاني", "طلال المطيري", "منصور الدوسري", "عبدالعزيز العمري",
];
...
const PRODUCTS = [
  { slug: "wrinkles-dark-circles", name: "زيت العوافي لآلام الركبة والظهر والمفاصل" },
  { slug: "anti-aging", name: "زيت العوافي لآلام المفاصل والديسك" },
];
const STATUS_POOL = [
