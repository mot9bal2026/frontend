...
function buildOrders(): DemoOrder[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const unit = qty === 1 ? 199 : qty === 2 ? 279 : 349;
...
function serializeDetail(o: DemoOrder) {
  return {
    ...
    items: o.upsell_accepted
      ? [
          { product_slug: o.upsell_offered!, product_name_ar: PRODUCTS.find((p) => p.slug === o.upsell_offered)?.name ?? o.upsell_offered!, qty: o.total_sar > 199 ? 1 : 1, price_sar: o.subtotal_sar, is_bridge_upsell: false },
